...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (IsProofOfStake())
    {
        ...
        // Xcloudcoin: check proof-of-stake block signature
...
// xcloudcoin: attempt to generate suitable proof-of-stake
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Xcloudcoin going ahead";
        CTransaction txNew;
        txNew.nTime = 1411406778;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x4ed0fd93298a767716112732c5ee3a6f30fda4ebdfd48e631a0ad3cf19ea2fde"));
        block.print();
