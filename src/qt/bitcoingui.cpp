    ...
    rpcConsole(0)
{
    ...
    setWindowTitle(tr("Xcloudcoin"));
    qApp->setStyleSheet("QMainWindow { background:rgb(255,255,255);font-family:'Open Sans,sans-serif'; } #frame { } QToolBar QLabel { padding-top:15px;padding-bottom:10px;margin:0px; } #spacer { background:rgb(0,43,104);border:none; } #toolbar2 { border:none;width:10px; background-color:qlineargradient(x1: 0, y1: 0, x2: 0.5, y2: 0.5,stop: 0 rgb(0,43,104), stop: 1 rgb(0,43,104)); } #toolbar { border:none;height:100%;padding-top:20px; background: rgb(0,43,104); text-align: left; color: white;min-width:200px;max-width:200px;} QToolBar QToolButton:hover {background-color:qlineargradient(x1: 0, y1: 0, x2: 2, y2: 2,stop: 0 rgb(0,43,104), stop: 1 rgb(0,43,104),stop: 2 rgb(0,43,104));} QToolBar QToolButton { font-family:Century Gothic;padding-left:20px;padding-right:100px;padding-top:10px;padding-bottom:10px; width:100%; color: white; text-align: left; background-color: rgb(0,43,104) } #labelMiningIcon { padding-left:5px;font-family:Century Gothic;width:100%;font-size:10px;text-align:center;color:white; } QMenu { background: rgb(0,43,104); color:white; padding-bottom:10px; } QMenu::item { color:white; background-color: transparent; } QMenu::item:selected { background-color:qlineargradient(x1: 0, y1: 0, x2: 0.5, y2: 0.5,stop: 0 rgb(0,43,104), stop: 1 rgb(0,43,104)); } QMenuBar { background: rgb(0,43,104); color:white; } QMenuBar::item { font-size:12px;padding-bottom:12px;padding-top:12px;padding-left:15px;padding-right:15px;color:white; background-color: transparent; } QMenuBar::item:selected { background-color:qlineargradient(x1: 0, y1: 0, x2: 0.5, y2: 0.5,stop: 0 rgb(0,43,104), stop: 1 rgb(0,43,104)); }");
#ifndef Q_OS_MAC
...
statisticsAction = new QAction(QIcon(":/icons/statistics"), tr("&Statistics"), this);
    ...
    messageAction = new QAction(QIcon(":/icons/mine"), tr("&Messages"), this);
    ...
    newsAction = new QAction(QIcon(":/icons/social"), tr("&Services"), this);
    newsAction->setStatusTip(tr("Check the xcloudcoin official website"));
    ...
    exchangeAction->setStatusTip(tr("Trade XCLD in major exchanges"));
...
connect(statisticsAction, SIGNAL(triggered()), this, SLOT(gotoStatisticsPage()));
    ...
    aboutCardAction = new QAction(tr("Xcloudcoin Website"), this);
    aboutCardAction->setToolTip(tr("Go to Xcloudcoin website"));
    ...
    encryptWalletAction = new QAction(QIcon(":/icons/lock_closed"), tr("&Encrypt Xcloudcoin..."), this);
    encryptWalletAction->setToolTip(tr("Encrypt or decrypt wallet"));
    encryptWalletAction->setCheckable(true);
    backupWalletAction = new QAction(QIcon(":/icons/filesave"), tr("&Backup Xcloudcoin..."), this);
    backupWalletAction->setToolTip(tr("Backup Xcloudcoin to another location"));
    changePassphraseAction = new QAction(QIcon(":/icons/key"), tr("&Change Passphrase..."), this);
    changePassphraseAction->setToolTip(tr("Change the passphrase used for wallet encryption"));
    unlockWalletAction = new QAction(QIcon(":/icons/lock_open"), tr("&Unlock Xcloudcoin..."), this);
    unlockWalletAction->setToolTip(tr("Unlock Xcloudcoin"));
    lockWalletAction = new QAction(QIcon(":/icons/lock_closed"), tr("&Lock Xcloudcoin"), this);
    lockWalletAction->setToolTip(tr("Lock Xcloudcoin"));
...
{
    QDesktopServices::openUrl(QUrl("http://www.thexcloudcoin.in/"));
}
...
void BitcoinGUI::setEncryptionStatus(int status)
{
    ...
    case WalletModel::Unlocked:
        ...
        labelEncryptionIcon->setToolTip(tr("Xcloudcoin is <b>encrypted</b> and currently <b>unlocked</b>"));
    ...
    case WalletModel::Locked:
        ...
        labelEncryptionIcon->setToolTip(tr("Xcloudcoin is <b>encrypted</b> and currently <b>locked</b>"));
        encryptWalletAction->setChecked(true);
        changePassphraseAction->setEnabled(true);
...
void BitcoinGUI::backupWallet()
{
    ...
    QString filename = QFileDialog::getSaveFileName(this, tr("Backup Xcloudcoin"), saveDir, tr("Xcloudcoin Data (*.dat)"));
    if(!filename.isEmpty()) {
        if(!walletModel->backupWallet(filename)) {
            QMessageBox::warning(this, tr("Backup Failed"), tr("There was an error trying to save the Xcloudcoin data to the new location."));
        }
    }
}
...
void BitcoinGUI::updateStakingIcon()
{
    ...
    else
    {
        ...
        if (pwalletMain && pwalletMain->IsLocked())
            labelStakingIcon->setToolTip(tr("Not staking because Xcloudcoin is locked"));
        else if (vNodes.empty())
            labelStakingIcon->setToolTip(tr("Not staking because Xcloudcoin is offline"));
        else if (IsInitialBlockDownload())
            labelStakingIcon->setToolTip(tr("Not staking because Xcloudcoin is syncing"));
        else if (!nWeight)
