// Copyright (c) 2014 The Xcloudcoin developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("xcloudcoin-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("xcloudcoin-smsg-pow"); // Make this thread recognisable
